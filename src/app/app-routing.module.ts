...
{path: 'editavatar/:url' , component:EditPageAvatarComponent},
{path: 'overviewavatar/:url' , component:AvatarOverviewComponent},
{path: 'testgame' , component:TestgameComponent},
{path: 'createposter' , component:CreatePosterComponent},
{path: 'editposter/:id' , component:EditPagePosterComponent},
{path: 'editstand/:id' , component:EditPageStandComponent},
{path: 'createstand' , component:CreateStandComponent},
{path:'overviewposter/:id', component:PosterOverviewComponent},
{path:'overviewstand/:id', component:StandOverviewComponent},
{path:'createplayer', component:CreatePlayerComponent},

{path:'testtt', component:TableAvatarComponent},

{path:'editplayer/:email' ,component:EditPagePlayerComponent},
{path:'overviewplayer/:email' ,component:PlayerOverviewComponent},
